...
// QueryProposer queries the proposer edge of a TaskAssignee.
func (c *TaskAssigneeClient) QueryProposer(_m *TaskAssignee) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryApprover queries the approver edge of a TaskAssignee.
func (c *TaskAssigneeClient) QueryApprover(_m *TaskAssignee) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryTaskAssigneeEntries queries the task_assignee_entries edge of a User.
func (c *UserClient) QueryTaskAssigneeEntries(_m *User) *TaskAssigneeQuery {
	query := (&TaskAssigneeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryProposedAssignees queries the proposed_assignees edge of a User.
func (c *UserClient) QueryProposedAssignees(_m *User) *TaskAssigneeQuery {
	query := (&TaskAssigneeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryApprovedAssignees queries the approved_assignees edge of a User.
func (c *UserClient) QueryApprovedAssignees(_m *User) *TaskAssigneeQuery {
	query := (&TaskAssigneeClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
