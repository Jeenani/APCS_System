...
func (_u *RefreshTokenUpdate) SetDeviceInfo(v string) *RefreshTokenUpdate {
	_u.mutation.SetDeviceInfo(v)
	return _u
}

// SetNillableDeviceInfo sets the "device_info" field if the given value is not nil.
func (_u *RefreshTokenUpdate) SetNillableDeviceInfo(v *string) *RefreshTokenUpdate {
	if v != nil {
		_u.SetDeviceInfo(*v)
	}
	return _u
...
func (_u *RefreshTokenUpdate) ClearDeviceInfo() *RefreshTokenUpdate {
...
func (_u *RefreshTokenUpdate) check() error {
	...
	if v, ok := _u.mutation.DeviceInfo(); ok {
		if err := refreshtoken.DeviceInfoValidator(v); err != nil {
			return &ValidationError{Name: "device_info", err: fmt.Errorf(`ent: validator failed for field "RefreshToken.device_info": %w`, err)}
		}
	}
...
func (_u *RefreshTokenUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.DeviceInfo(); ok {
		_spec.SetField(refreshtoken.FieldDeviceInfo, field.TypeString, value)
	}
	if _u.mutation.DeviceInfoCleared() {
		_spec.ClearField(refreshtoken.FieldDeviceInfo, field.TypeString)
	}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *RefreshTokenUpdateOne) SetDeviceInfo(v string) *RefreshTokenUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}

// SetNillableDeviceInfo sets the "device_info" field if the given value is not nil.
func (_u *RefreshTokenUpdateOne) SetNillableDeviceInfo(v *string) *RefreshTokenUpdateOne {
	if v != nil {
		_u.SetDeviceInfo(*v)
	}
	return _u
...
// ClearDeviceInfo clears the value of the "device_info" field.
func (_u *RefreshTokenUpdateOne) ClearDeviceInfo() *RefreshTokenUpdateOne {
	_u.mutation.ClearDeviceInfo()
	return _u
}
